...
<%--    <link rel="stylesheet" href="${pageContext.request.contextPath}/bootstrap/css/bootstrap.css">--%>
    <link href="${pageContext.request.contextPath}/login_files/default.css" rel="stylesheet" type="text/css">
    <!--必要样式-->
    <link href="${pageContext.request.contextPath}/login_files/styles.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/login_files/demo.css" rel="stylesheet" type="text/css">
    <link href="${pageContext.request.contextPath}/login_files/loaders.css" rel="stylesheet" type="text/css">
</head>
    ...
    <form action="${pageContext.request.contextPath}/user/login1" method="get">
        <div class="login_fields">
            <%--<div class="login_fields__user">
                ...
                <input name="account" placeholder="用户名" maxlength="16" type="text" autocomplete="off" required oninvalid="setCustomValidity('请输入您的用户名');" oninput="setCustomValidity('');">
            ...
            <div class="login_fields__password">
                <div class="icon">
                    <img alt="" src="${pageContext.request.contextPath}/login_files/lock_icon_copy.png">
                </div>
                <input name="password" placeholder="密码" maxlength="16" type="password" autocomplete="off" required oninvalid="setCustomValidity('请输入您的密码');" oninput="setCustomValidity('');">
                <div class="validation">
                    <img alt="" src="${pageContext.request.contextPath}/login_files/tick.png">
                </div>
            </div>--%>
...
<link href="${pageContext.request.contextPath}/login_files/layui.css" rel="stylesheet" type="text/css">

<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/jquery.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/jquery-ui.min.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/stopExecutionOnTimeout.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/layui.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/Particleground.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/Treatment.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/jquery.mockjax.js.下载"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/ThreeWebGL.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/ThreeExtras.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/Detector.js.下载"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/login_files/RequestAnimationFrame.js.下载"></script>
